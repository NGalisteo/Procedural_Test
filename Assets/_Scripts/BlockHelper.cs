...
public static class BlockHelper
{
    ...
    public static MeshData GetFaceDataIn(Direction direction, ChunkData chunk, int x, int y, int z, MeshData
        meshData, BlockType blockType)
    {
    ...
    public static Vector2[] FaceUVs(Direction direction, BlockType blockType)
    {
        ...
        UVs[0] = new Vector2(
        BlockDataManager.tileSizeX * tilePos.x + BlockDataManager.tileSizeX - 
